...
namespace Drupal\standard_reports\Controller;

use Drupal\Core\Controller\ControllerBase;


use Drupal\standard_reports\Service\ReportService;
use Symfony\Component\DependencyInjection\ContainerInterface;
use Symfony\Component\HttpFoundation\RequestStack;

/**
 * Provides the Product performance page controller.
 *
 * This controller handles the request for the Product performance,
...
class ProductPerformanceReportController extends ControllerBase {
   ...
   * The report service.
   *
   * @var \Drupal\standard_reports\Service\ReportService
   */
  protected $reportService;

  /**
   * Constructs a new ProductPerformanceReportController.
   *
   * @param \Symfony\Component\HttpFoundation\RequestStack $request_stack
   *   The request stack.
   * @param \Drupal\standard_reports\Service\ReportService $report_service
   *   The report service.
   */
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      ...
      $container->get('standard_reports.report_service')
    );
  }
  ...
  public function build(): array {
    ...
    $form = $this->formBuilder()->getForm('Drupal\standard_reports\Form\ReportsFilterForm');
